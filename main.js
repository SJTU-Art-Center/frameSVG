var app = new Vue({
    ...
    methods:{
        update: function(){
            var maincode = "<section powered-by=\"Art Center\""+ (this.bg==""?"":" style=\"background-size: 100%;background-repeat: no-repeat; background-color:blue; background-image: url(" + this.bg + ")\"") +">\n";
            // section 不会被微信和谐
            // div 会被微信和谐
